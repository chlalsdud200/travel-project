 ...
 * REVIEW 댓글 수정
 */
@WebServlet("/reviewReplyUpdate.do")
public class ReviewReplyUpdate extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    int res;
    if (isAdmin) {
      res = service.reviewReplyAdminUpdate(vo); // ✅ UPDATE: '[ADMIN_EDITED] ' || reCtt
    } else {
      res = service.reviewReplyUpdate(vo);      // ✅ 일반 UPDATE
    }
